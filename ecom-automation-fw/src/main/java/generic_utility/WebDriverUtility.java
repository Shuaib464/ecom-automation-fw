 ...
 * management, waits, drop-down selections, mouse and keyboard interactions.
 * It also includes additional utilities such as alerts, scrolling, screenshot,
 * JS execution, drag-drop, sliders, and more.
 * 
 * @version a12
 * 
 * @author Shuaib Ahamad
 */
public class WebDriverUtility {
	 ...
	 * 
	 * @param element WebElement to send ENTER
	 */
